...
class AuthScreens extends ConsumerStatefulWidget {
  const AuthScreens({super.key});

  @override
  ConsumerState<AuthScreens> createState() => _SignUpScreenState();
}

class _SignUpScreenState extends ConsumerState<AuthScreens> {
                  ...
                  child: Column(
                    ...
                    30.verticalSpace,
                      Padding(
                        ...
                        child: CustomButton(
                          text: _isLogin ? 'Continue with Google' : 'Sign up with Google',
                          backgroundColor: AppColors.primarySoft, // Light grey from design
                          textColor: theme.colorScheme.onSurface,
                          iconWidget: CustomSvg(AppIcons.google, size: 40.sp,),
                          onPressed: () {},
                        ),
                      ),
                      30.verticalSpace,
                      CustomButton(text: _isLogin ? 'Login' : 'Continue', onPressed: () {
                      ...
                      // Add your CustomButtons down here!
                      // CustomButton(text: _isLogin ? 'Login' : 'Continue', ...)
                    ],
                  ),
                ),
              ),
